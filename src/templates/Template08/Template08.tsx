...
export const Template08: React.FC<Template08Props> = ({
  ...
  return (
    <div
      className={`relative w-full ${isOpen ? "min-h-screen overflow-y-auto" : "h-full max-h-full overflow-hidden"} bg-[#FFF7ED] text-[#3F3F46] font-sans antialiased overflow-x-hidden ${className}`}
    >
      {/* Audio Player Toggle */}
      {data.audio.enabled && (
        <AudioPlayerToggle
      ...
      {/* Interactive Modern Diamond Wax Seal & 3D Gatefold Unfolding Experience */}
      <WaxSealEnvelope
