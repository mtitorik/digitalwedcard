...
import { SAMPLE_TEMPLATES, SampleWeddingTemplate, getTemplateBySlug } from "@/data/sampleTemplates";
...
export default function ExploreCardsPage() {
  ...
  const getCardTheme = (card: PublicCard) => {
    ...
    // Theme by templateThemeId if stored
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 sm:pt-12">
        ...
        <div className="text-center max-w-3xl mx-auto mb-10">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-amber-400/10 border border-amber-400/30 text-amber-300 text-xs font-semibold uppercase tracking-widest mb-4">
            ...
            <span>Curated Sample Templates • Unique Aesthetic Themes</span>
          </div>
        ...
        {loading ? (
          ...
          <div className="bg-[#082920]/80 border border-amber-400/20 rounded-3xl p-12 text-center max-w-md mx-auto text-amber-300/70">
            ...
            <button
              ...
              className="px-4 py-2 rounded-xl bg-amber-400 text-emerald-950 text-xs font-bold"
            >
              Reset Filters
            </button>
          </div>
        ...
        <div className="mt-16 bg-gradient-to-r from-[#0a382c] to-[#082920] border border-amber-400/30 rounded-3xl p-8 sm:p-12 text-center max-w-3xl mx-auto shadow-2xl relative overflow-hidden">
          ...
          <p className="text-xs sm:text-sm text-stone-300 max-w-lg mx-auto mb-6 leading-relaxed">
            Pick any design template above or start from scratch. Each invitation comes with real-time RSVP management,
            wishes guestbook, personalized countdown, and acoustic ceremony chimes.
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
            <Link
              href="/dashboard"
              className="inline-flex items-center gap-2 px-6 py-3.5 rounded-full bg-gradient-to-r from-amber-400 via-amber-500 to-amber-600 text-emerald-950 font-semibold text-sm shadow-xl hover:brightness-110 transition-all"
            >
